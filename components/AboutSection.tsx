...
export default function AboutSection() {
  return (
    <section className="relative py-24 overflow-hidden bg-gradient-to-b from-white to-gray-50 dark:from-background dark:to-background/80">
      {/* Background Elements */}
      <div className="absolute inset-0">
        ...
        {/* Soft glow effects */}
        <div className="absolute top-0 -right-1/4 w-1/2 h-1/2 bg-blue-100/20 dark:bg-blue-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 -left-1/4 w-1/2 h-1/2 bg-purple-100/20 dark:bg-purple-500/10 rounded-full blur-3xl" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              ...
              <span className="text-white">Against Adversarial Attacks</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {highlights.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl transform transition-transform group-hover:scale-105 duration-300" />
                  <div className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 hover:border-blue-500/50 transition-colors">
